...
<body class="bg-gray-200">
    <div class="dashboard-container p-4">
        <h1 class="text-3xl font-semibold text-center text-blue-500 mb-4">Manager Dashboard</h1>

        <div class="user-info-box mb-8">
            <h2 class="text-2xl font-semibold text-gray-800 mb-2">Welcome, <?php echo $username; ?></h2>
            <p class="text-gray-600">Here's your manager dashboard.</p>
        </div>

        <div class="p-4 bg-white rounded-lg shadow-md mb-4">
            <h2 class="text-2xl font-semibold text-gray-800">Manage Team</h2>
            <p class="text-gray-600">You can manage your team members here.</p>
        </div>
